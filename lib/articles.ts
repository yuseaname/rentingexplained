...
export const articles: Article[] = [
  ...
  },
  {
    ...
    title: 'First Apartment Checklist 2025: The Complete $5,000 Budget Breakdown',
    description: 'Moving into your first apartment? Get the complete checklist with exact costs, room-by-room essentials, and 3 budget tiers ($2K/$5K/$8K).',
    content: '',
    author: 'RentingExplained Editorial Team',
  ...
  },
  {
    ...
    title: 'Breaking a Lease Without Penalty: 11 Legal Exit Strategies (2025 Guide)',
    description: 'Need to break your lease early? Learn 11 legal ways to end a lease without penalty in 2025, plus templates, a decision tree, and mitigation tips.',
    content: '',
    author: 'RentingExplained Editorial Team',
