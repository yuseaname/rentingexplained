            ...
            <div className="sticky top-24 space-y-8">
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="space-y-2">
                  {['Money Saving', 'Legal Rights', 'Costs', 'Technology', 'Financial Planning'].map((category) => (
                    <Link
                      key={category}
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {['rent-negotiation', 'tenant-rights', 'lease-agreement', 'budgeting', 'apartment-hunting'].map((tag) => (
