...
export default function FeaturedGuides() {
  const guides = [
    ...
    {
      title: 'Hidden Rental Fees Explained',
      description: 'Uncover and avoid unexpected costs when renting',
      href: '/blog/hidden-rental-fees-explained',
      image: 'https://images.unsplash.com/photo-1554224311-beee4a72adcf?w=800&auto=format&fit=crop',
      category: 'Costs',
