...
1) Open with interest and timing.
2) Make one clear request.
3) Add one brief reason (comp, timing, or flexibility).
...
1) You have at least three comparable listings saved.
- A) Yes
- B) Some, but not close matches
- C) No

2) You know your max monthly total (rent + fees).
- A) Yes
- B) Rough estimate
- C) Not yet

3) Your request is one clear, specific change.
- A) Yes
- B) Maybe two changes
- C) Not sure

4) You know your move-in or renewal timeline.
- A) Yes
- B) Rough window
- C) Not sure

5) You have a back-up option if they say no.
- A) Yes
- B) A maybe
- C) No
...
**Ready:** Mostly A answers. You have the basics and can send a clear request.
Shareable line: "I got Ready on the RentingExplained quiz - worth checking."

**Close:** Mostly B answers. Tighten your comps and decide your exact ask.
Shareable line: "I got Close on the RentingExplained quiz - worth checking."
