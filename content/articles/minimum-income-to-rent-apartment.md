...
If you want to compare real costs, use the [Rent Budget Checker](/tools/rent-budget-checker).
...
If you plan to use a cosigner, make sure they understand the responsibility. The [Renting With Bad Credit guide](/blog/renting-with-bad-credit-options) explains how cosigners work.
...
If these costs are high, your affordable rent may be lower than the 3x rule suggests. Use [Hidden Rental Fees Explained](/blog/hidden-rental-fees-explained) to see how fees can change your total.
...
2) Your debt payments are...
- A) Low
- B) Moderate
- C) High

3) Your savings buffer is...
- A) Strong
- B) Small
- C) None

4) Your utilities and fees are...
- A) Low
- B) Moderate
- C) High
...
**Safe:** Your rent target is likely sustainable. Keep your documents ready and apply early.
Shareable line: "I got Safe on the RentingExplained quiz -- worth checking."

**Stretch:** You might qualify, but the budget could feel tight. Review expenses and build a buffer.
Shareable line: "I got Stretch on the RentingExplained quiz -- worth checking."
