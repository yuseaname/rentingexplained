...
- [What “hidden fees” really are](#what-hidden-fees-are)
- [Move-in fees to ask about](#move-in-fees)
- [Monthly add-ons that change the price](#monthly-addons)
- [Questions to ask on a tour](#tour-questions)
- [Lease clauses that deserve a second look](#lease-clauses)
- [How to get a fee schedule in writing](#get-fee-schedule)
- [How to negotiate fees (scripts)](#negotiation)
- [Compare apartments by true monthly cost](#compare-total)
- [2-minute quiz](#fee-transparency-quiz)
- [Printable checklist + copy/paste template](#fee-checklist)
- [FAQ](#faq)
...
know right now.
- 
**Do you have a written fee schedule?**
A: Yes.
- B: Not yet, but they offered to send it.
- C: No, and they avoid the question.
- 
**Do you know the required monthly add-ons?**
A: Yes, itemized.
- B: I have some, but not all.
- C: No.
- 
**Do you know how utilities are billed?**
A: Yes.
- B: Somewhat.
- C: No.
- 
**Do you understand move-out fees and notice steps?**
A: Yes, written.
- B: Some details are unclear.
- C: No.
- 
**Can you calculate a “true monthly cost” today?**
A: Yes.
