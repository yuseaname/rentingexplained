---
title: "Security Deposits: The Complete Guide for Renters"
...
This guide is general information, not legal advice. Security deposit rules vary significantly by state and city. For state-specific details, see our [state-by-state tenant laws overview](/state-laws/) and the specific articles linked throughout.
...
1. **Cover unpaid rent** if you move out without paying
2. **Repair damage** beyond normal wear and tear
3. **Cover other lease violations** spelled out in the lease (cleaning, key replacement, etc.)
...
For a complete state-by-state table, see our [security deposits overview](/blog/security-deposits-and-evictions-overview).
...
For a full breakdown of move-in costs, see our [complete move-in cost guide](/blog/apartment-move-in-costs).
...
1. **Walk through the unit with the landlord or property manager** — use a written checklist
2. **Photograph every room** — wide shots, close-ups, and any existing damage
3. **Video the entire unit** — narrate as you walk through ("this is the existing scratch on the hardwood near the bedroom door")
4. **Date-stamp everything** — use a phone with location services and timestamps enabled
5. **Email the photos to the landlord** that day — confirm receipt in writing
6. **Sign the move-in condition report** — and note any disagreements in writing
7. **Keep a copy of everything** — both digital and physical
...
For a complete walkthrough checklist, see our [first apartment checklist guide](/blog/first-apartment-checklist-guide-2025) and our [apartment tour checklist](/blog/apartment-tour-checklist-questions-red-flags).
...
For more on tenant responsibilities during the tenancy, see our [renter's rights guide](/blog/renters-rights-guide).
...
This is the single biggest dispute at move-out. For a deeper dive, see our complete guide to [normal wear and tear vs. damage](/blog/normal-wear-and-tear-vs-damage).
...
For a complete move-out checklist, see our [apartment move-out checklist](/blog/apartment-move-out-checklist).
...
1. **Tenant requests inspection** — usually at least 1–2 weeks before move-out
2. **Landlord inspects the unit** — flags potential deductions
3. **Tenant has time to fix** — usually 24–72 hours
4. **Final inspection** — confirms whether issues were resolved
5. **Final walk-through** — both parties sign the move-out condition report
...
For a complete state-by-state timeline table, see our [security deposit return timeline guide](/blog/security-deposit-return-timeline).
...
For a complete breakdown of what is legal and what is not, see our guide to [security deposit deductions](/blog/security-deposit-deductions-explained).
...
For a complete walkthrough of the dispute process, see our [security deposit deductions guide](/blog/security-deposit-deductions-explained).
...
1. **Document move-in condition** — photos, video, written checklist
2. **Get the move-in condition report in writing** — signed by both parties
3. **Send all repair requests in writing** — keep copies
4. **Pay rent on time** — keep all receipts and bank records
5. **Document any damage** — during the tenancy, with timestamps
6. **Request a move-out inspection** — at least 2 weeks before moving
7. **Fix what the landlord flags** — within 24–72 hours
8. **Document move-out condition** — photos and video the day you leave
9. **Provide a forwarding address in writing** — required by most states
10. **Follow up if the deposit is late** — send a demand letter and escalate

For more detail on every step, see our [how to get your security deposit back](/blog/how-to-get-security-deposit-back) guide.
...
For more detail, see our [state-by-state tenant laws overview](/state-laws/) and [tenant rights by state guide](/blog/tenant-rights-by-state-overview).
...
Landlords cannot refuse Section 8 tenants in many jurisdictions (source-of-income discrimination is banned in many states). The deposit rules are the same, but the landlord may need to follow additional Housing Choice Voucher (HCV) program rules. For more, see our [Section 8 housing vouchers guide](/blog/section-8-housing-vouchers-explained).
...
For more on negotiating lease terms, see our [how to negotiate rent guide](/blog/how-to-negotiate-rent-guide).
...
{{< faq "How much can a landlord charge for a security deposit?" >}}
Most states cap the deposit at one or two months' rent. Some states allow more for furnished units, pets, or special tenants. A few states have no statutory cap. Check your state law for the exact limit.
{{< /faq >}}

{{< faq "Can my landlord keep my deposit for normal wear and tear?" >}}
No. Normal wear and tear is not damage and cannot be deducted. The deposit can only be used for actual damage beyond normal wear, unpaid rent, lease violations, and cleaning beyond normal use. For a detailed breakdown, see our [normal wear and tear guide](/blog/normal-wear-and-tear-vs-damage).
{{< /faq >}}

{{< faq "How long does my landlord have to return my deposit?" >}}
It depends on your state. Most states require 14 to 30 days. A few states allow up to 60 days. For a complete table, see our [security deposit return timeline guide](/blog/security-deposit-return-timeline).
{{< /faq >}}

{{< faq "What if my landlord does not return my deposit or send an itemized list?" >}}
Several states impose automatic penalties for missing the deadline — some award 2x to 3x the deposit amount. Send a written demand letter, and if the landlord still does not respond, file in small claims court. For a complete walkthrough, see our [security deposit deductions guide](/blog/security-deposit-deductions-explained).
{{< /faq >}}

{{< faq "Should I send a forwarding address after I move out?" >}}
Yes. Most states require you to provide a forwarding address in writing before the landlord is required to return the deposit. Send it by email and certified mail, and keep a copy. Without a forwarding address, the landlord may have a legal excuse to delay the return.
{{< /faq >}}
...
- Our [security deposit deductions guide](/blog/security-deposit-deductions-explained)
- Our [how to get your deposit back guide](/blog/how-to-get-security-deposit-back)
- Our [security deposits overview](/blog/security-deposits-and-evictions-overview)
- Our [security deposits guide](/blog/security-deposits-guide)
- Our [state-by-state tenant laws](/state-laws/)
- Our [renters rights guide](/blog/renters-rights-guide)
