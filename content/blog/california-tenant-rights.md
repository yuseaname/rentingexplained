---
title: "California Tenant Rights in 2026: The Complete Guide"
slug: "california-tenant-rights"
description: "California renter rights explained: the one-month deposit cap, rent increase limits, just-cause eviction, and the deadlines landlords cannot miss."
date: 2026-08-15
lastmod: 2026-08-15
...
>
> New here? Start with the [first-time renters guide](/blog/first-time-renters-guide/) or check your state at a glance on the [state laws map](/state-laws/ca/).
...
- [Security Deposits: The One-Month Cap](#security-deposits-the-one-month-cap)
- [Getting Your Deposit Back: The 21-Day Rule](#getting-your-deposit-back-the-21-day-rule)
- [Rent Increases and Rent Control](#rent-increases-and-rent-control)
- [Eviction: Just Cause and the Notice Rules](#eviction-just-cause-and-the-notice-rules)
- [Repairs and Habitability](#repairs-and-habitability)
- [Landlord Entry: 24-Hour Notice](#landlord-entry-24-hour-notice)
...
- [Renters Insurance in California](#renters-insurance-in-california)
...
|---|---|---|
| **AB 12** | July 1, 2024 | Security deposit cap cut from 2–3 months to **1 month** for most landlords (small-landlord exception: 2 months) |
| **AB 2801** | Phased through 2025 | **Photos required** at move-in, move-out, and post-repair before any deduction for damage or cleaning |
| **AB 414** | January 1, 2026 | Electronic deposits must be **refunded electronically**; refund checks payable as tenants direct |

The practical effect: move-in and move-out documentation now matters more than ever, and it cuts both ways — tenants should take their own dated photos at both ends of the tenancy, because the landlord's deductions need photographic support and yours do too. Our [apartment move-out checklist](/blog/apartment-move-out-checklist/) includes the photo workflow.
...
|---|---|
| **1 month max** | Default cap for nearly all landlords, furnished or not |
...
| Deposits collected before July 1, 2024 | Unchanged if lawful when collected |
| Pet deposits | Must fit inside the same cap — no extra deposit on top |
...
If a landlord charges more than the cap on a new lease, you can demand the excess back — and overcharges can support a small-claims claim. Our [security deposits guide](/blog/security-deposits-guide/) covers what counts, what doesn't, and how to document from day one.

### What your deposit can and cannot cover

Landlords may deduct for unpaid rent, repair of damage **beyond normal wear and tear**, and cleaning only to make the unit as clean as when you moved in. They cannot deduct for ordinary wear, expected painting, or repairs that were already needed. The line gets litigated constantly — our [normal wear and tear vs. damage guide](/blog/normal-wear-and-tear-vs-damage/) shows the difference with real examples.
...
| Situation | 2026 rule |
|---|---|
| Covered building, 12-month cap | 5% + regional CPI, **max 10%** |
| Building newer than ~15 years | Exempt from AB 1482 |
| Single-family home / condo | Exempt only with proper written notice from an individual owner |
| Rent-controlled city (LA, SF, Oakland, etc.) | Local cap applies — often stricter |
| De controlled / exempt units | No cap, but eviction protections may still apply |

### Local rent control

Many cities add stronger caps: Los Angeles' RSO (roughly 3–4% most years), San Francisco, Oakland, Berkeley, and Santa Monica all run their own systems, often with registration requirements and lower ceilings. Local rules prevail where stronger. Check your city's rent board before assuming the 10% state max applies — and see our [rent increase and renewal guide](/blog/rent-increase-renewal-guide/) for how to respond to an increase notice, and [how to negotiate rent](/blog/how-to-negotiate-rent-guide/) for scripts that work in California markets.
...
| Tenure | Notice for no-lease-termination | Rent increase notices |
|---|---|---|
| Month-to-month, under 1 year | 30 days | 30 days (≤10% increase); 90 days (>10%, only if exempt) |
| Month-to-month, over 1 year | 60 days | Same |
| No-fault eviction (any tenure) | 30–90 days + relocation assistance | — |

The eviction process itself — the court filing, the unlawful detainer timeline, and what you can do at each stage — is covered in our [eviction process explained](/blog/eviction-process-explained/) guide. If you're leaving voluntarily, our [notice to vacate letter template](/blog/notice-to-vacate-letter-template/) gives you a compliant California-format letter.
...
You can refuse entry that doesn't meet these rules, and repeated unauthorized entry violates your right to quiet enjoyment. Our [landlord entry notice requirements guide](/blog/landlord-entry-notice-requirements/) has the state-by-state comparison and what to do about a landlord who shows up unannounced.
...
- **Source-of-income protections.** California forbids discriminating against Section 8 vouchers and other lawful income — landlords must count voucher payments as income. See our [Section 8 housing vouchers explained](/blog/section-8-housing-vouchers-explained/) guide for how the program works, and [renting with bad credit](/blog/renting-with-bad-credit-options/) if your report is the obstacle.
...
For the full application picture: [rental application checklist](/blog/rental-application-checklist/), [proof of income for apartments](/blog/proof-of-income-for-apartments/), and [apartment approval requirements](/blog/apartment-approval-requirements/).
...
{{< faq "How long does a California landlord have to return a security deposit?" >}}
...
{{< faq "How much can a landlord raise rent in California in 2026?" >}}
...
{{< faq "Can a California landlord evict without a reason?" >}}
...
{{< faq "How much notice must a landlord give before entering?" >}}
...
{{< faq "Are pet deposits legal in California?" >}}
...
{{< faq "What can I do if my landlord keeps my deposit unfairly?" >}}
...
{{< faq "Is California rent control statewide?" >}}
...
{{< faq "Can a landlord reject my Section 8 voucher in California?" >}}
...
- [State laws: California quick reference](/state-laws/ca/)
...
- [Rent increase and renewal guide](/blog/rent-increase-renewal-guide/)
...
- [2025 rental cost index by state](/blog/2025-rental-cost-index-by-state/)

*Last verified August 2026 against Civil Code §1950.5 (AB 12, AB 2801, AB 414), the Tenant Protection Act of 2019 (AB 1482), and current city rent-board guidance. Laws change — confirm specifics with the [California Department of Real Estate](https://www.dre.ca.gov/), your city rent board, or a tenant attorney before acting.*
