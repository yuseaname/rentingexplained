---
title: "Can Your Landlord Enter Without Notice? State-by-State Rules"
...
This guide is general information, not legal advice. Local rules may differ from state law, and local rules usually prevail when they are stricter. For a broader overview, see our [landlord entry notice requirements guide](/blog/landlord-entry-notice-requirements).
...
For a detailed state-by-state breakdown, see our [state laws overview](/state-laws/).
...
For more on what your lease can and cannot do, see our [understanding a lease agreement guide](/blog/understanding-a-lease-agreement).
...
{{< faq "Can my landlord enter my apartment without my permission?" >}}
Generally, no. With proper notice (typically 24 hours), the landlord can enter for inspections, repairs, and showings even without your specific permission. Without notice, entry is unauthorized except in true emergencies. For more on entry notice requirements, see our [landlord entry notice requirements guide](/blog/landlord-entry-notice-requirements).
{{< /faq >}}

{{< faq "Can a landlord enter without 24 hours notice for repairs?" >}}
...
{{< faq "What if my landlord uses a master key to enter without telling me?" >}}
...
{{< faq "Can my landlord enter to show the apartment to new tenants?" >}}
...
{{< faq "What should I do if my landlord entered without notice?" >}}
Document the entry (date, time, who, what they did). Send a written notice citing your state's notice requirement and requesting compliance. If the pattern continues, contact local code enforcement, file a complaint with your state Attorney General, or pursue legal action including small claims court. For the full framework, see our [landlord entry notice requirements guide](/blog/landlord-entry-notice-requirements).
{{< /faq >}}

## Next Steps

Unauthorized entry is a violation of your right to quiet enjoyment, and the law is generally on your side. Document every incident, send written notices, and escalate if the pattern continues. For more on your rights and state-specific rules, see our [landlord entry notice requirements guide](/blog/landlord-entry-notice-requirements) and our [state-by-state tenant laws overview](/state-laws/).