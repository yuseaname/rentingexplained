---
title: "Normal Wear and Tear vs. Damage: What Landlords Can Charge For"
...
This guide is general information, not legal advice. Local rules vary. For a complete overview of deposit law, see our [security deposits complete guide](/blog/security-deposits-complete-guide).
...
1. Photograph every wall, floor, ceiling, fixture, and appliance
2. Take close-ups of any existing damage
3. Take a video walkthrough with narration
4. Date-stamp the photos (most phones do this automatically)
5. Email the photos to the landlord that day

### Move-Out Day

1. Photograph every room after cleaning and moving out
2. Take a video walkthrough with narration
3. Compare current photos to move-in photos
4. Document any damage that was already there
5. Email the photos to the landlord
...
For a complete move-out checklist, see our [apartment move-out checklist](/blog/apartment-move-out-checklist) and our [how to get your deposit back guide](/blog/how-to-get-security-deposit-back).
...
For a full breakdown of deduction rules, see our [security deposit deductions guide](/blog/security-deposit-deductions-explained).
...
{{< faq "Can a landlord deduct for repainting?" >}}
Generally, no. Routine repainting is normal wear and tear unless the walls were damaged (large holes, unauthorized paint, smoke damage). For a complete framework on what is and isn't deductible, see our [security deposit deductions guide](/blog/security-deposit-deductions-explained).
{{< /faq >}}

{{< faq "How long does carpet last before it must be replaced?" >}}
Most carpets have a useful life of 5–10 years depending on quality and traffic. If the carpet was old when you moved in, the landlord generally cannot deduct full replacement cost. For a detailed breakdown by item, see our [security deposits complete guide](/blog/security-deposits-complete-guide).
{{< /faq >}}

{{< faq "What if the landlord claims damage that was already there?" >}}
This is exactly why move-in photos matter. With timestamped photos showing the damage at move-in, you can dispute the deduction in writing. Without photos, it is much harder. For more on documentation, see our [how to get your deposit back guide](/blog/how-to-get-security-deposit-back).
{{< /faq >}}

{{< faq "Can a landlord charge for cleaning?" >}}
Yes, but only for cleaning beyond normal wear. A landlord cannot charge a "cleaning fee" simply because a new tenant is moving in. The unit must be cleaned, but the cost of preparing for a new tenant is the landlord's business expense, not the prior tenant's deposit.
{{< /faq >}}

{{< faq "What if my landlord refuses to acknowledge my photos?" >}}
Send them in writing with a clear date and your signature. Save copies of everything. If the landlord still refuses, file in small claims court and bring the photos as evidence. Most judges will accept timestamped photos as strong evidence.
{{< /faq >}}

## Next Steps

The difference between wear and tear and damage is the key to every deposit dispute. Document the unit at move-in, document it again at move-out, and dispute any deduction that does not match the actual condition. For a complete roadmap to every part of the deposit process, see our [security deposits complete guide](/blog/security-deposits-complete-guide) and our [how to get your deposit back guide](/blog/how-to-get-security-deposit-back).
