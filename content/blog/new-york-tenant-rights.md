---
title: "New York Tenant Rights in 2026: The Complete Guide"
slug: "new-york-tenant-rights"
description: "New York renter rights explained: the one-month deposit cap, 14-day refund rule, Good Cause Eviction, the FARE Act broker-fee shift, and habitability protections."
date: 2026-08-15
lastmod: 2026-08-15
...
>
> New here? Start with the [first-time renters guide](/blog/first-time-renters-guide/) or check your state at a glance on the [state laws map](/state-laws/ny/).
...
- [What changed in 2024–2026](#what-changed-in-2024-2026)
- [Security Deposits: One Month Max, 14 Days Back](#security-deposits-one-month-max-14-days-back)
- [Rent Regulation: Stabilization, Control, and Good Cause](#rent-regulation-stabilization-control-and-good-cause)
- [Good Cause Eviction in NYC](#good-cause-eviction-in-nyc)
- [The FARE Act: Who Pays the Broker Fee](#the-fare-act-who-pays-the-broker-fee)
- [Eviction: The Process and Notice Rules](#eviction-the-process-and-notice-rules)
- [Repairs and Habitability](#repairs-and-habitability)
- [Landlord Entry](#landlord-entry)
- [Application Fees and Screening](#application-fees-and-screening)
- [Discrimination and Retaliation](#discrimination-and-retaliation)
- [Renters Insurance in New York](#renters-insurance-in-new-york)
...
The 14-day rule is unusually strict and unusually tenant-favorable: blow the deadline and the itemized statement is gone, along with every deduction. If your landlord misses it, send a written demand citing GOL §7-108(1-a) — many refund the full amount rather than litigate a forfeiture. Our [security deposits guide](/blog/security-deposits-guide/) covers the full move-out playbook, and [how to get your security deposit back](/blog/how-to-get-security-deposit-back/) has the letter templates.
...
1. **No eviction or non-renewal without good cause.** The landlord must prove a statutory reason: nonpayment (unless caused by an unreasonable rent increase), substantial lease violation, nuisance, illegal use, owner occupancy, demolition, or taking the unit off the rental market. Owner-occupancy, demolition, and withdrawal claims require "clear and compelling evidence" in court.
2. **Rent increase cap.** An increase above the **local rent standard** is presumed unreasonable: the standard is **regional inflation + 5%, capped at 10%**. (HPD's example: 3% inflation → 8% standard; 6% inflation → 10% cap.) An unreasonable increase can't be the basis of a nonpayment eviction.
3. **Notice requirement.** When a landlord offers a rent increase above 5%, the notice must state whether Good Cause applies to the apartment.
...
1. Check coverage: building size, owner's total units, construction date, your rent vs. FMR.
2. If covered and the increase exceeds the local rent standard (inflation + 5%, max 10%), respond in writing that you accept a renewal at the standard and contest the excess.
3. On a non-renewal, don't just move out — Good Cause is a defense in Housing Court, and legal aid (or NYC's right-to-counsel program for many zip codes) can appear with you.
4. Document everything: the notice, your lease, rent payment history, and correspondence.

Our [eviction process explained](/blog/eviction-process-explained/) guide covers what happens after a filing, and [how to negotiate rent](/blog/how-to-negotiate-rent-guide/) has scripts for the renewal conversation before it gets there.
...
Practical effect for apartment hunting in 2026: a "no-fee" listing should now genuinely cost you no broker fee, and any fee demanded by a landlord-side broker is a red flag worth reporting. Our [hidden rental fees explained](/blog/hidden-rental-fees-explained/) guide covers the rest of the fee landscape, and the [rental application checklist](/blog/rental-application-checklist/) has the document prep that makes applications competitive.
...
After the notice period, the landlord files in Housing Court (or Supreme Court outside NYC), you get served and have a right to answer, and only a marshal or sheriff with a warrant can remove you. Illegal lockouts, utility shutoffs, or removing your door are self-help eviction — call 311 and a tenant attorney immediately. The full timeline is in [eviction process explained](/blog/eviction-process-explained/).

If you're leaving on your own terms, the [notice to vacate letter template](/blog/notice-to-vacate-letter-template/) gives you a New York-format letter, and [breaking a lease without penalty](/blog/breaking-a-lease-without-penalty-2025/) covers the state's limited early-termination rights.
...
1. **Written repair request** — start the paper trail. NYC 311 service requests create official records.
2. **HPD inspection** — violations issued against the building become public record and pressure.
3. **Withholding rent for breach of the warranty** — a defense if the landlord sues for nonpayment (risky; do it with counsel).
4. **Repair-and-deduct via HPD's Alternative Enforcement Program** — for serious violations, the city fixes and bills.
5. **Housing Court HP action** — a tenant-initiated case ordering repairs.

Heat season (October 1 – May 31) has specific temperature floors: 68°F indoors from 6 a.m. to 10 p.m. when it's below 55°F outside, and 62°F overnight. No heat in February is an emergency complaint, not a routine request. The complete escalation playbook is in [tenant rights when your landlord won't make repairs](/blog/tenant-rights-when-landlord-won-t-make-repairs/).
...
You can refuse entry that lacks reasonable notice, and repeated unannounced entry can support a harassment claim under NYC's tenant-harassment law (which covers repeated attempts to make you leave, including utility interruptions and excessive-entry campaigns). Our [landlord entry notice requirements guide](/blog/landlord-entry-notice-requirements/) compares all 50 states and covers what to do about a landlord who won't call first.
...
If your income or credit is the obstacle, see [renting with bad credit](/blog/renting-with-bad-credit-options/) and [proof of income for apartments](/blog/proof-of-income-for-apartments/). Source-of-income discrimination — refusing Section 8 vouchers or other lawful income — is illegal in New York City and much of the state; our [Section 8 vouchers explained](/blog/section-8-housing-vouchers-explained/) guide covers the program.
...
**Retaliation** within one year of a protected act (complaining to HPD, organizing tenants, asserting any right in this guide) is presumed improper — an eviction or rent hike following a complaint shifts the burden to the landlord to prove a legitimate, independent reason. The general framework is in [renter's rights: what your landlord cannot legally do](/blog/renters-rights-guide/).

## Renters Insurance in New York

Renters insurance in New York City typically runs **$15–$25/month** for $30,000 of coverage. Two local notes: ground-floor and basement units should check flood coverage (standard policies exclude it), and the city's older building stock makes fire and water-discharge liability the claims you're most likely to actually use. Our [renters insurance cost guide](/blog/renters-insurance-cost-2025/) has the full breakdown, and many NYC landlords now require it — see [hidden apartment fees](/blog/hidden-apartment-fees/) for how to read that lease clause.

## Frequently Asked Questions

{{< faq "What is the maximum security deposit in New York?" >}}
One month's rent for most residential tenancies, including unregulated apartments (General Obligations Law §7-108, HSTPA 2019). Rent-stabilized units follow the same cap. The landlord must hold it in a New York bank account and tell you where.
{{< /faq >}}

{{< faq "How long does a New York landlord have to return a security deposit?" >}}
14 days after you move out, with an itemized statement of any deductions. If the landlord misses the 14-day deadline, they forfeit the right to keep any part of the deposit — the full amount is refundable regardless of damage claims. Send a written demand citing GOL §7-108(1-a) if the deadline passes.
{{< /faq >}}

{{< faq "What is Good Cause Eviction and does it apply to me?" >}}
A New York State law (in effect April 20, 2024) that NYC and several other cities adopted. In covered apartments it prevents eviction or lease non-renewal without a legally recognized reason and caps rent increases at the local rent standard (regional inflation + 5%, max 10%). It does not cover apartments owned by small landlords (10 or fewer units statewide), condo/co-op units, buildings constructed on or after January 1, 2009, units renting above 245% of Fair Market Rent, or high-income households above the threshold HCR publishes each year. Check your coverage before assuming either way.
{{< /faq >}}

{{< faq "Do I have to pay a broker fee in NYC?" >}}
Not if the broker was hired by the landlord. Since June 11, 2025, the FARE Act prohibits landlord-side brokers (including listing agents) from charging tenants any fee — the landlord pays. You can voluntarily hire your own broker with a written agreement, but a listing can't require you to hire the landlord's broker to access an apartment. Report violations to DCWP via 311.
{{< /faq >}}

{{< faq "How much notice does a landlord give before entering my apartment?" >}}
New York law requires reasonable notice at a reasonable time for non-emergency entry — there's no fixed statutory number of hours, but 24 hours is the common practice and many leases specify it. Emergencies allow immediate entry. Repeated unannounced entry can constitute harassment under NYC law.
{{< /faq >}}

{{< faq "How much can a landlord raise rent in New York?" >}}
Rent-stabilized apartments: only by the annual Rent Guidelines Board percentages. Market-rate apartments with a current lease: nothing until renewal unless the lease allows it. Month-to-month tenants without Good Cause coverage: any amount with one month's notice. Good Cause-covered apartments: increases above regional inflation + 5% (max 10%) can be challenged in court.
{{< /faq >}}

{{< faq "Can a landlord evict me without going to court?" >}}
No. Self-help eviction — changing locks, removing your belongings, shutting off utilities — is illegal in New York. A landlord must win a court case and obtain a warrant of eviction, executed only by a city marshal or sheriff. Before filing, they must serve proper notice (for example, a 14-day rent demand in nonpayment cases). If you're locked out illegally, call 311, the police, and a tenant attorney.
{{< /faq >}}

{{< faq "What are my rights if my landlord won't make repairs?" >}}
Every New York lease carries the warranty of habitability (RPL §235-b): heat, hot water, and a safe, sanitary home. Document the problem in writing, file a 311 complaint (HPD inspects and issues violations), and escalate to an HP action in Housing Court if needed. You may defend a nonpayment case on habitability grounds, and retaliation for repair complaints is presumed unlawful within one year.
{{< /faq >}}

{{< faq "Is there a limit on application fees in New York?" >}}
Yes — HSTPA caps application fees at $20, limited to the landlord's actual documented screening costs. Late fees are capped at the less of $50 or 5% of monthly rent, applicable only to rent more than 5 days late.
{{< /faq >}}

## Related guides

- [State laws: New York quick reference](/state-laws/ny/)
- [Tenant rights by state: the overview](/blog/tenant-rights-by-state-overview/)
- [Security deposits: how to get yours back](/blog/security-deposits-guide/)
- [Security deposit return timelines by state](/blog/security-deposit-return-timeline/)
- [Eviction process explained](/blog/eviction-process-explained/)
- [Breaking a lease without penalty](/blog/breaking-a-lease-without-penalty-2025/)
...
- [Month-to-month lease guide](/blog/month-to-month-lease-guide/)

*Last verified August 2026 against General Obligations Law §7-108, RPAPL §711, RPL §235-b and Article 6-A, NYC's FARE Act materials from DCWP, and HPD's Good Cause Eviction guidance. Laws change — confirm specifics with [NYC HPD](https://www.nyc.gov/site/hpd/index.page), [HCR](https://hcr.ny.gov/), 311, or a tenant attorney before acting.*
