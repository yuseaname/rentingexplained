---
title: "Security Deposit Deductions Explained: What's Legal and What's Not"
...
This guide is general information, not legal advice. For the full picture, see our [security deposits complete guide](/blog/security-deposits-complete-guide).
...
For a complete list of what counts as wear and tear vs. damage, see our [normal wear and tear vs. damage guide](/blog/normal-wear-and-tear-vs-damage).
...
{{< faq "Can a landlord keep my deposit for cleaning?" >}}
Only if the cleaning was beyond normal use. Routine cleaning between tenants is a normal business expense and cannot be deducted. The landlord must also provide receipts in most states. For the full framework, see our [security deposits complete guide](/blog/security-deposits-complete-guide).
{{< /faq >}}

{{< faq "What if my landlord doesn't send an itemized list of deductions?" >}}
Several states (California, Florida, Massachusetts, Texas, Nevada) forfeit the landlord's right to claim any deductions if no itemized list is provided. The full deposit must be returned. Check your state law — your demand letter should cite this rule.
{{< /faq >}}

{{< faq "Can I sue my landlord in small claims court?" >}}
Yes. Small claims court is the most common remedy for deposit disputes. Filing fees are typically $30–$100, and you do not need an attorney. Most states allow claims up to $5,000–$10,000. For state-by-state return timelines, see our [security deposit return timeline guide](/blog/security-deposit-return-timeline).
{{< /faq >}}

{{< faq "How long does a deposit dispute take?" >}}
A demand letter usually resolves the dispute in 7–14 days. If you file in small claims court, the hearing is typically scheduled 30–60 days after filing. Most cases resolve before trial — about 60–70% of small claims cases settle when the landlord sees the tenant's evidence.
{{< /faq >}}

{{< faq "Can a landlord charge for repainting?" >}}
Generally, no. Routine repainting between tenants is a normal business expense. The landlord can only charge for repainting if there is actual damage (large holes, unauthorized paint, smoke damage) that goes beyond normal wear. For more on what is and isn't deductible, see our [normal wear and tear vs. damage guide](/blog/normal-wear-and-tear-vs-damage).
{{< /faq >}}
...
- Our [security deposits complete guide](/blog/security-deposits-complete-guide)
